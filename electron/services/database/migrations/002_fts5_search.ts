export const version = '002_fts5_search'
export const name = '002_fts5_search.sql'
...
CREATE VIRTUAL TABLE IF NOT EXISTS occupations_fts USING fts5(
  ...
  content='occupations', content_rowid='rowid',
  tokenize='unicode61 remove_diacritics 1'
);
...
CREATE VIRTUAL TABLE IF NOT EXISTS certifications_fts USING fts5(
  ...
  content='certifications', content_rowid='rowid',
  tokenize='unicode61 remove_diacritics 1'
);
