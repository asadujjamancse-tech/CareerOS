...
CREATE INDEX IF NOT EXISTS idx_skills_status
  ON skills (status) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_skills_proficiency_level
  ON skills (proficiency_level) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_skills_active
  ON skills (created_at) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_occupations_status
  ON occupations (status) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_occupations_active
  ON occupations (created_at) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_projects_type
  ON projects (type) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_projects_featured
  ON projects (is_featured) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_projects_started_at
  ON projects (started_at) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_certifications_status
  ON certifications (status) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_certifications_expiry_date
  ON certifications (expiry_date) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_certifications_issuer
  ON certifications (issuer) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_videos_watch_status
  ON videos (watch_status) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_videos_source
  ON videos (source) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_videos_created_at
  ON videos (created_at) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_notes_type
  ON notes (type) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_notes_pinned
  ON notes (is_pinned) WHERE deleted_at IS NULL AND is_pinned = 1;

CREATE INDEX IF NOT EXISTS idx_notes_updated_at
  ON notes (updated_at) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_journal_entries_entry_date
  ON journal_entries (entry_date) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_journal_entries_category
  ON journal_entries (category) WHERE deleted_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_journal_entries_mood
  ON journal_entries (mood) WHERE deleted_at IS NULL;
